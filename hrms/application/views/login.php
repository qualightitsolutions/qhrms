...
<body>
    ...
    <section id="wrapper" class="login-register " style="background-image:url('http://teds.com/files/8513/8971/1384/workforce_management_banner.png');">
        ...
        <div class="login-box card">
            <div class="card-body">
							...
							?>   
       <img src="http://www.qualightit.net/img/qualight_logo.png">							
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                 ...
                 <div class="form-check">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-warning btn-lg btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Log In</button>
                        </div>
                    </div>
                </form>
            </div>
